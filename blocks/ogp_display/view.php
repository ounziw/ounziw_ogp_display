...
if ($ogp) {
    ...
    if ($targetblank) {
        $reltarget = ' rel="nofollow noopener noreferrer" target="_blank"';
    } else {
        $reltarget = '';
    }
    ?>
    <div class="row ogplink">
        <div class="col-xs-12 ogplinktitle">
            <p class="ogplinktitle"><a href="<?php echo h($url);?>"<?php echo $reltarget;?>><?php echo h($ogp['title']);?></a></p>
        </div>
        <a href="<?php echo h($url);?>"<?php echo $reltarget;?>><?php echo $tag; ?></a>
